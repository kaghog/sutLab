...
"""
Apply gravity model to generate a distance matrix for Hannover’s Mikrobezirke.
"""
...
def configure(context):
    context.stage("hannover.gravity.distance_matrix")
    context.stage("hannover.ipf.attributed")
    context.stage("hannover.data.census.employees")
...
def execute(context):
    # Load data
    df_distances = context.stage("hannover.gravity.distance_matrix")
    df_population = context.stage("hannover.ipf.attributed")
    df_employees = context.stage("hannover.data.census.employees")
