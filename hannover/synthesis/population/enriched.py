...
def configure(context):
    ...
    context.stage("hannover.data.mid.data")
    context.stage("hannover.data.mid.zones")
...
def execute(context):
    ...
    # load MiD
    df_zones = context.stage("hannover.data.mid.zones")
    mid = context.stage("hannover.data.mid.data")
