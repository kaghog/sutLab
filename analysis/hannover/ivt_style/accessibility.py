...
CELL_SIZE_M = [500.0, 1000.0]    # grid cell sizes in meters (short diagonal for hex)

# Analysis thresholds
PT_STOP_DISTANCE_M = [200.0, 500.0]  # thresholds for "within" stop distance
...
def plot_choropleth_map(
    ...
    """
    Generic function to create choropleth maps.
...
def configure(context):
    """
    Analysis stage: accessibility proof of concept.
    """
...
def execute(context):
    ...
    plot_persons_distance_heatmap(persons_df, stops_df, analysis_path)
