...
def execute(context):
    ...
    df_number_of_cars = df_population[["household_id", "has_vehicle"]].drop_duplicates("household_id")
    ...
    df_car_availability.loc[df_car_availability["has_vehicle"] == "No", "car_availability"] = "none"
    ...
    df_population.loc[df_population["has_vehicle"] == "No", "bicycle_availability"] = "none"
